...
contract FantomAudioWaves is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private _tokenIdCounter;
    address payable public depositAddress = payable(0xFc3778f4b877B25A2A6B501a6Bd987bB6B43F7e0);
    uint256 public maxMintable = 200;
    string private _baseUrl;
      string public baseExtension = ".json";

    constructor(string memory baseUrl) ERC721("FantomAudioWaves", "WAVES") {
        _baseUrl = baseUrl;
    }
